...
import * as fromActions from '../../../../src/products/store/actions/index';
import * as fromReducers from '../../../../src/products/store/reducers/index';
import * as fromSelectors from '../../../../src/products/store/selectors/pizzas.selectors';
...
describe('Pizzas Selectors', () => {
  ...
  describe('getPizzaState', () => {
    it('should return state of pizza store slice', () => {
      ...
      store
        .select(fromSelectors.getPizzasState)
