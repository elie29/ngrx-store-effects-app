import * as fromActions from '../../../../src/products/store/actions/toppings.action';
import * as fromReducer from '../../../../src/products/store/reducers/toppings.reducer';
...
describe('PizzasReducer Selectors', () => {
  describe('getToppingEntities', () => {
    it('should return .entities', () => {
      ...
      const slice = fromReducer.getToppingEntities(state);
  ...
  describe('getSelectedToppings', () => {
    it('should return .selectedToppings', () => {
      ...
      const { initialState } = fromReducer;
      const state = { ...initialState, selectedToppings };
      const slice = fromReducer.getSelectedToppings(state);
  ...
  describe('getToppingsLoading', () => {
    it('should return .loading', () => {
      ...
      const slice = fromReducer.getToppingsLoading(state);
  ...
  describe('getToppingsLoaded', () => {
    it('should return .loaded', () => {
      ...
      const slice = fromReducer.getToppingsLoaded(state);
  ...
  describe('getSelectedToppings', () => {
    it('should return .selectedToppings', () => {
      const { initialState } = fromReducer;
      const state = { ...initialState, selectedToppings: [1, 2, 4] };
      const slice = fromReducer.getSelectedToppings(state);

      expect(slice).toEqual([1, 2, 4]);
    });
  });
});
